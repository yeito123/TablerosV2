t<%@ Page Language="vb" AutoEventWireup="false" enableViewState="true" CodeBehind="TCitas.aspx.vb" Inherits="TablerosV2.TCita" %>
             ...
             <asp:DataGrid ID="dgIndicadoresDias" runat="server" AutoGenerateColumns="false"  
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText=""  >
                            <ItemTemplate>
                                <div runat="server" id="divzed" >
                                    <table ><tr> <td><cc22:ZedGraphWeb   ID="ZedGraphWeb2" runat="server"
                                    FontSpec-Size="2" Legend-FontSpec-Size="0"  Margins-Bottom="0" Margins-Left="0" Margins-Right="0" Margins-Top="0"
                                    Height="25" ChartBorder-IsVisible="false" IsFontsScaled="false" Legend-IsVisible="false"
                                      XAxis-FontSpec-Size="1" XAxis-Scale-FontSpec-Size="10"
                                    IsShowTitle="false" XAxis-IsShowTitle="false" YAxis-IsShowTitle="false" YAxis-IsVisible="false"
    ...
    <div style="z-index: 3003; left: 0px; width: 1121px; position: absolute; height: 500px; " id="divInterfaz"
      ...
      <asp:ImageButton ID="imgRefrescar" runat="server" ImageUrl="img/Refresh.png"
       ...
       <div id="divCalendar"  >
            ...
            <img alt="" id="imgclCalendar" src="img/calendar.png" style="cursor: hand; z-index: 5000;
                           ...
                           <%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "cilindros") > 0, "CILINDROS: ", "")%>
                            ...
                            <tr>
                                <td> <%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "campana") > 0, "CAMPANA: ", "")%> </td>
                                    <td><asp:RadioButtonList runat="server" id="rdlCampa" ><asp:ListItem Selected="True" Text="NO" Value="0"></asp:ListItem><asp:ListItem   Text="SI" Value="1"></asp:ListItem></asp:RadioButtonList></td>
                                <td> <%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "movilidad") > 0, "MOVILIDAD: ", "")%> </td>
                                    <td><asp:RadioButtonList runat="server" id="rdlMovilidad" ><asp:ListItem Selected="True" Text="NO" Value="0"></asp:ListItem><asp:ListItem   Text="SI" Value="1"></asp:ListItem></asp:RadioButtonList></td>
                                
                                <td align="left" colspan="3"> <asp:TextBox ID="txtMovilidad" Width="200px"   runat="server"  ></asp:TextBox></td>
                                 </tr>
                            <tr>
                                <td> <%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "servicei") > 0, "SERVICE INCLUSIVE: ", "")%> </td>
                                    <td><asp:RadioButtonList runat="server" id="rdlServiceInclusive" ><asp:ListItem Selected="True" Text="NO" Value="0"></asp:ListItem><asp:ListItem  Text="SI" Value="1"></asp:ListItem></asp:RadioButtonList></td>
                                 <td> <%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "garantia") > 0, "GARANTIA: ", "")%> </td>
                                    <td><asp:RadioButtonList runat="server" id="rdlGarantia" ><asp:ListItem Selected="True" Text="NO" Value="0"></asp:ListItem><asp:ListItem   Text="SI" Value="1"></asp:ListItem></asp:RadioButtonList></td>
                                <td align="left" colspan="3"> <asp:TextBox ID="txtGarantia" Width="200px"   runat="server"  ></asp:TextBox></td>
                            </tr>
                             <tr>
                                <td> <%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "medio") > 0, "MEDIO DE CONCRETACION DE CITA: ", "")%> </td>
                                    <td><asp:DropDownList runat="server" id="rdlMedio" >
                                ...
                                <td> <%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "contacto") > 0, "MEDIO PREFERIDO DE CONTACTO: ", "")%> </td>
                                    <td><asp:DropDownList runat="server" id="rdlContacto" >
