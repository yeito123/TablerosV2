...
//debugger;
          ...
          if (chipboard != "pop" && chipboard != "mnu" && chipboard != "div")
    {
          ...
          // Appoinment board 
          if (chiplayer == "dr" || chiplayer == "dy" || chiplayer == "dg" || chiplayer == "ds" || chiplayer == "dp" || ddName == "dchp")
          {
                if (ddName != "dchp")
                {
...
//debugger;
    ...
    if (chipboard != "pop" && chipboard != "mnu" && chipboard != "div")
 {
     ...
     if (ddName != "dchp" && ddName.substr(0,2)!="ds") {
         ...
         document.getElementById("dhtml").value = ddName + "." + xImg1 + "." + yImg1 + "." + document.getElementById("divInterfaz").style.posTop + "." + document.getElementById("imgTrash").style.posTop;
         if (yImg1 >= document.getElementById("imgTrash").style.posTop && xImg1 >= document.getElementById("imgTrash").style.posLeft && yImg1 < document.getElementById("imgTrash").style.posTop + 330 && xImg1 < document.getElementById("imgTrash").style.posLeft + 1228) {
