<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TblCalidadV2.aspx.vb" Inherits="TablerosV2.TblCalidadV2" %>
        ...
        <div class="container cssHeader jumbotron" style="width: 100%;">
            <div id="divheader" class="container form-group page-header">
                <div id="divImagenLogo" class="form-inline" >
                    <asp:Image runat="server" ID="ImgLogo" ImageUrl="~/img/AgenciaLogoHeader.png"  Height="60px" Style="float: left;" />
                    ...
                    <asp:Panel runat="server" ID="pnlAgregarNuevo" Style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="cmdServicios" runat="server" CssClass="form-control input-sm">
								...
								<asp:ListItem>Pre Prueba con cliente</asp:ListItem>
								<asp:ListItem>Pre Prueba con tecnico</asp:ListItem>
                    ...
                    <div class="container" style="text-align: center; width: 100%; padding-top: 3em;">
                        <asp:DataGrid runat="server" ID="GridPendientes" Visible="false" CssClass=" table table-striped table-condensed" GridLines="None"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Iniciar">
                                    <ItemTemplate>
                                        <asp:ImageButton
                                ...
                                <asp:TemplateColumn HeaderText="Finalizar">
                                    <ItemTemplate>
                                         <asp:ImageButton
                                        ...
                                        <asp:TemplateColumn HeaderText="Retrabajo">
                                    <ItemTemplate>
                                          <asp:ImageButton
                                    ...
                                    <ItemTemplate>
                                            ...
                                            Height="1em"
                                            Visible="true" 
											OnClientClick="javascript:if(!confirm('¿Seguro desea Eliminar este Vehículo?'))return false" />
                                         </ItemTemplate>
                                </asp:TemplateColumn>
