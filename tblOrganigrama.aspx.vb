...
Public Class tblOrganigrama
	...
	Private Sub inicializaVariables()
		...
		interval = Validaciones.getTiempoTimer("%tblorganigrama%") 'trae el tiempo que debe permanecer esta pantalla
		Timer5.Interval = interval * 1000
		pantalla = Validaciones.getpantallaTimer("%tbloganigrama%") 'trae la pantalla a la que debe dirigirse
	End Sub
	...
	Protected Sub timer5_tick(sender As Object, e As EventArgs) Handles Timer5.Tick
		Response.Redirect("tblpullrecepcion.aspx")
	End Sub
