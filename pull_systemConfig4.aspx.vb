...
Partial Public Class pull_systemConfig4
    ...
    Sub PINTACHIPS()
        ...
        sqry = "SELECT idFicha, fichaTop, fichaLeft, IMGCCITA, IMGSCITA FROM TB_CHIP_PULL2"
        dtPos = BDClass.SQLtoDataTable(sqry, False)
    ...
    Sub GuardaChip(ByVal sChip As String)
        ...
        sqry = "SELECT max(CONVERT(INT,right(idficha,2))) FROM TB_CHIP_PULL2 WHERE  LEFT(idficha,1)='" & sIdFicha & "'"
        dt = BDClass.SQLtoDataTable(sqry, False)
        ...
        If sIdFicha = "b" Then
            sqry = "SELECT isnull(max(bahia),0) FROM TB_CHIP_PULL2 WHERE  LEFT(idficha,1)='" & sIdFicha & "'"
            dt = BDClass.SQLtoDataTable(sqry, False)
            ...
            End If
            sqry = "insert into TB_CHIP_PULL2(idFicha, FichaLeft, FichaTop,imgCCita,imgSCita, bahia) values ('" & sIdFicha & String.Format("{0:00}", idFicha) & "'," & Split(sChip, ".")(2) & " ," & Split(sChip, ".")(3) & ",'" & sImgCC & "','" & sImgSC & "'," & ibahia & ")"
            BDClass.ExecuteQuery(sqry, False)

        Else
            sqry = "insert into TB_CHIP_PULL2(idFicha, FichaLeft, FichaTop,imgCCita,imgSCita) values ('" & sIdFicha & String.Format("{0:00}", idFicha) & "'," & Split(sChip, ".")(2) & " ," & Split(sChip, ".")(3) & ",'" & sImgCC & "','" & sImgSC & "')"
            BDClass.ExecuteQuery(sqry, False)
        ...
        Select Case cboColorChip.SelectedItem.Value
            Case "Red"
                sqry = "UPDATE   TB_CHIP_PULL2 SET imgCCita='img/v_red_v_l.gif',imgSCita='img/v_blue_v_l.gif' where imgccita='img/v_blue_v_l.gif' or imgccita='img/v_red_v_l.gif'"
                BDClass.ExecuteQuery(sqry, False)
                sqry = "UPDATE   TB_CHIP_PULL2 SET imgCCita='img/v_red_h_l.gif',imgSCita='img/v_blue_h_l.gif' where imgccita='img/v_blue_h_l.gif' or imgccita='img/v_red_h_l.gif'"
                BDClass.ExecuteQuery(sqry, False)

            Case "Blue"
                sqry = "UPDATE   TB_CHIP_PULL2 SET imgCCita='img/v_blue_v_l.gif',imgSCita='img/v_red_v_l.gif' where imgccita='img/v_blue_v_l.gif' or imgccita='img/v_red_v_l.gif'"
                BDClass.ExecuteQuery(sqry, False)
                sqry = "UPDATE   TB_CHIP_PULL2 SET imgCCita='img/v_blue_h_l.gif',imgSCita='img/v_red_h_l.gif' where imgccita='img/v_blue_h_l.gif' or imgccita='img/v_red_h_l.gif'"
                BDClass.ExecuteQuery(sqry, False)
        End Select
    ...
    Sub ActualizaChip(ByVal sChip As String)
        ...
        sqry = "update TB_CHIP_PULL2 set fichaLeft=" & Split(sChip, ".")(2) & " , fichaTop=" & Split(sChip, ".")(3) & " where idFicha='" & Split(sChip, ".")(1) & "'"
        BDClass.ExecuteQuery(sqry, False)
        PINTACHIPS()
    ...
    Sub EliminarChip(ByVal sChip As String)
        ...
        sqry = "delete TB_CHIP_PULL2 where idFicha='" & Split(sChip, ".")(1) & "'"
        BDClass.ExecuteQuery(sqry, False)
        PINTACHIPS()
