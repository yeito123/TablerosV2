<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TblEstados.aspx.vb" Inherits="TablerosV2.TblEstados" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.refMensaje').click(function () {
                agencia = "(Nombre del consecionario)"
            ...
            $('.chkSalida').click(function () {
                if (confirm('¿Esta seguro que desea darle salida al vehículo con placas: ' + this.dataset.placas2 + '?')) {
                    $('#lblPLacaMsg').val(this.dataset.idhd2);
                    __doPostBack('btnSalida', '');
                }
                else {
                    return false
                }
...
<body style="margin-bottom: 0">
    <form id="form1" runat="server" class="form-inline">
        ...
        <asp:Button ID="btnSalida" runat="server" Text='GuardaRegistro' Style="display: none;"></asp:Button>
            ...
            <div id="DivCuerpo" class="auto-style3" style="padding: 2em;">
                <asp:DataGrid runat="server" ID="GridCuerpoAsesores" CssClass="table-responsive table-condensed"
                    ...
                    <Columns>
                        ...
                        <%--<asp:BoundColumn DataField="Contactado" HeaderText="Contacto" ReadOnly="true" Visible="true"></asp:BoundColumn>--%>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="col-lg-2">
                                         ...
                                         <td class="col-lg-2">
                                            <asp:Button runat="server" ID="btnPdf" Text="MPS" OnClick="btnPdf_Click" CssClass="btn-primary form-control" />
                                        </td>
                                        <td class="col-lg-2">
                                            <asp:Button runat="server" ID="btncontrato" Text="OR" OnClick="btncontrato_Click" CssClass="btn-primary form-control" />
                                        </td>
                                    </tr>
                                </table>
                            </ItemTemplate>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">
                            ...
                            <asp:Label runat="server" ID="InfoIdhd" />
                        </h4>
                    </div>
                    <div class="modal-body">
                        <div>
                            <div id="dvlform" class="form-group" style="padding: 1em;">
                                ...
                                <asp:Button ID="btnCambia" runat="server" Text="Cambiar Estado" CssClass="btn-default form-control"></asp:Button>
                            </div>
        ...
        <!-- mpe para mensaje -->
        <ajaxtoolkit:ModalPopupExtender ID="mpe2" runat="server" TargetControlID="btnCambia" PopupControlID="PanelMensaje"
            Enabled="true" Drag="true" DropShadow="true" BackgroundCssClass="modalBack">
        </ajaxtoolkit:ModalPopupExtender>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="TituloMensaje">
                            <asp:Label runat="server" ID="lblTitulo2" Text="CAMBIO DE ESTADO"></asp:Label>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <asp:DropDownList runat="server" ID="cmdEstados" OnSelectedIndexChanged="cmdEstados_SelectedIndexChanged" AutoPostBack="true">
                            <asp:ListItem Value="0">ELIJA UN ESTADO</asp:ListItem>
                            <%--<asp:ListItem Value="1">TERMINADO</asp:ListItem>--%>
                            <asp:ListItem Value="2">DETENIDO POR REPUESTOS</asp:ListItem>
                            <asp:ListItem Value="3">DETENIDO POR AUTORIZACION</asp:ListItem>
                            <asp:ListItem Value="4">DETENIDO EN PROCESO</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
        ...
        <asp:UpdatePanel ID="pnlPanle" runat="server">
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="btnSalida" EventName="Click" />
            </Triggers>
        </asp:UpdatePanel>
    </form>
</body>
