<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pull_systemConfig2.aspx.vb" Inherits="TablerosV2.pull_systemConfig2" %>
    ...
    <div id="floatdiv" runat="server"  style="position: absolute;
        width: 1225px; height: 90px; left: 0px; top: 0px; z-index: 3002;" >
          ...
          <asp:ImageButton runat="server" ID="ImageButton1" ImageUrl="img/logout.png"
                    Width="40px" OnClick="ImageButton1_Click"  style=" display:none; position: relative; top: 0px; left: 1200px;"  />
                ...
                <td colspan="4">
                    <div class="gvContainer">
                        ...
                        <table   cellpadding="1" cellspacing="10" style=" position:relative;left:60px; width:80%; ">
                            <tr>
                            <td><asp:RadioButtonList ID="lstNivel" runat="server" AutoPostBack="true">
                        ...
                        <asp:ListItem Value="t" >Terminado por entregar de dias anteriores(t)</asp:ListItem>
                    ...
                    <asp:ListItem Value="img/v_red_v_l.gif__img/v_blue_v_l.gif" ></asp:ListItem>
                            ...
                            <tr>
                                <td >
                                Nivel
                                   <asp:DropDownList ID="cboNivel" runat="server" AutoPostBack="false" Visible="true">
