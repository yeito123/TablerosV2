<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pull_system4.aspx.vb" Inherits="TablerosV2.pull_system4" %>
...
<body  style="background-image: url(img/toyota_cn_servicio_8B.PNG);">
    ...
    <div id="floatdiv" style="position: absolute;
        width: 1225px; height: 90px; left: 990px; top: 0px; z-index: 3002;" runat="server">
         <img  alt="" src="img/agenciaLOGOHeader.PNG" style="position: relative; top: 40px; left: 10px;" />
         <asp:ImageButton runat="server" ID="ImageButton2" ImageUrl="img/logout2.png"
                    Width="1px"   OnClientClick="doNothing();" onkeyress="doNothing();" style="position: relative; top: -40px; left: 10px;"  />
          <asp:ImageButton runat="server" ID="ImageButton1" ImageUrl="img/logout.png"
                    Width="40px" OnClientClick="javascript:bSubmit = true;" OnClick="ImageButton1_Click"  onkeyress="doNothing();"  style="position: relative; top: 20px; left: 10px;"  />
     ...
     <div style=" position: absolute; left:1000px;top: 450px;width:250px; Font-Face:Calibri; border:1px  solid black;Font-Size:11px; font-weight: bold;">
     <table><tr><td>
      ASESORES
