<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pull_systemDetalle.aspx.vb" Inherits="TablerosV2.pull_systemDetalle" %>
    ...
    <form id="form1" runat="server" >
      ...
      <table class="TBLHEAD" style="width:100%;">
        <tr>
            ...
            <td>
                <asp:Label ID="lblStatus" runat="server" CssClass="LBLST" Text="Label"></asp:Label>
            </td>
