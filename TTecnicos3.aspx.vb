...
Partial Public Class TTecnicos3
    ...
    Property pgvDms() As Boolean
        Get
            Return Session("_pgvdmss")
        End Get
        Set(ByVal value As Boolean)
            Session("_pgvdmss") = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'If InStr(Page.AppRelativeVirtualPath, Session("URL")) = 0 Or Session("URL") Is Nothing Then
        ...
        If Not Page.IsPostBack Then
            bref = True
        End If
        If Session("fases") Is Nothing Then
            Session("fases") = 0
        End If
    ...
    '
        ...
        Session("imgLsts") = imgLst
        Session("imgLstPosMecs") = imgLstPosMec
    ...
    Protected Sub lblDescFase_click(ByVal sender As Object, ByVal e As EventArgs)
        Session("fases") = CType(CType(sender.parent, DataListItem).FindControl("lblFase"), Label).Text
        ...
        For i = 1 To OBJCOL.Count
            ...
            Try
                If objchip.STATUS.ToLower = "detenida" Or objchip.STATUS.ToLower = "iniciada" Or objchip.STATUS.ToLower = "reiniciada" Then
                    ...
                    sstop = CType(Session("dtPosYs"), DataTable).Select("OrdenP='" & objchip.NOORDEN & "' and IdTecnico='" & objchip.IDTECNICO & "'")(0)("posYP") + 30 & "px"
                Else
                    iNivel = 1
                    sstop = CType(Session("dtPosYs"), DataTable).Select("OrdenP='" & objchip.NOORDEN & "' and IdTecnico='" & objchip.IDTECNICO & "'")(0)("posYP") & "px"
                End If
            ...
            If Not Session("buscaChips") Is Nothing Then
                Select Case lstFind.SelectedItem.Value
                    Case "1"
                        ...
                        End If
                    Case "2"
                        If objchip.NOORDEN.ToString.Trim.ToLower = txtFind.Text.Trim.ToLower Then
                            oChip = "busqueda"
                        End If
                End Select
            End If
    ...
    Function ObtenToppx(ByVal noorden As String, ByVal sidservicio As String, ByVal snoplacas As String, ByVal scliente As String, ByVal iNivel As Integer) As String
        Dim dt As DataTable = Session("imgLstPosMecs")
    ...
    Private Sub whuxgaPT_PreRenderComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRenderComplete
        Dim OBJARRAY As ArrayList = CType(Session("imgLsts"), ArrayList)
    ...
    Private Sub MPGV_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MPGV.PreRender
        Session("DATEHYPs") = Date.Now.ToShortDateString
    End Sub
    ...
    Protected Sub Menu1_MenuItemClick(ByVal sender As Object, ByVal e As MenuEventArgs) Handles Menu1.MenuItemClick
        ...
        If Int32.Parse(e.Item.Value) = 0 Then
            Session.Remove("rbDets")
            Session("buscaChips") = False
    ...
    Protected Sub Timer13_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer13.Tick
        ...
        Response.Redirect("pull_system.aspx")
