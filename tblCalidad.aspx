<%@ Page Language="VB" AutoEventWireup="false" enableEventValidation="false" CodeBehind="tblCalidad.aspx.vb" Inherits="TablerosV2.tblCalidad" %>
                                    ...
                                    <asp:DataGrid ID="GridView1" runat="server"  AutoGenerateColumns="False" Width="1247px"
                                        ...
                                        <Columns>
                                         ...
                                         <asp:BoundColumn DataField="id" HeaderText="idItem"  ReadOnly="True"
                                            ...
                                            <asp:BoundColumn DataField="fecha_Hora_ini_Oper" HeaderText="Inicio" 
                                                Visible="False" ReadOnly="True">
                                                <ItemStyle HorizontalAlign="Center" Width="180px" />
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="Fecha_hora_fin_oper" HeaderText="Hora" 
                                                ReadOnly="True" Visible="true">
                                                <ItemStyle HorizontalAlign="Center" Width="180px" />
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="id_hd" HeaderText="" 
                                             ...
                                             <asp:BoundColumn DataField="status_a" HeaderText="Estatus" 
                                                ReadOnly="True">
                                                <ItemStyle HorizontalAlign="Center" Width="180px" />
                                            </asp:BoundColumn>
                                ...
                                <tr>
                                    <td>
                                        <asp:DataGrid runat="server" ID="GvFinish" AutoGenerateColumns="False" BackColor="White"
                                            ...
                                            <asp:BoundColumn DataField="Fecha_hora_fin_oper" HeaderText="Hoara" 
                                                ReadOnly="True" Visible="false">
                                                <ItemStyle HorizontalAlign="Center" Width="180px" />
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="id_hd" HeaderText="" 
                                             ...
                                             <asp:BoundColumn DataField="estatus_a" HeaderText="Estatus" 
                                                ReadOnly="True" Visible="false">
                                                <ItemStyle HorizontalAlign="Center" Width="180px" />
