<%@ Page Language="vb" AutoEventWireup="false" codefile="zcrmCuestionarioDetalleB.aspx.vb" Inherits="zcrmCuestionarioDetalleB" %>
    ...
    <div style="width: 1069px" >
        ...
        <asp:Panel runat="server" ID="PnlPReguntas" CssClass="div2">
            <table>
                <tr>
                    <td style="text-align: left">
                        <asp:Label runat="server" ID="LblLeyenda" Text="Esta encuesta nos ayudará a mejorar la calidad de nuestros servicios, le suplicamos nos regale unos minutos de su valioso tiempo:"
            ...
            <table>
                <tr>
                    <td class="style5">
                        <asp:Label runat="server" ID="Lbl12" Text="1.- ¿Su asesor entendió específicamente los problemas de su unidad?"></asp:Label>
                    </td>
                ...
                <tr>
                <td class="style5">
                        <asp:Label runat="server" ID="Label2" Text="2.- ¿Le entregaron su unidad cubriendo las sus expectativas de limpieza?"></asp:Label>
                    </td>
                ...
                <tr>
                    <td class="style5">
                        <asp:Label runat="server" ID="Label3" Text="3.-¿Le entregaron su vehiculo en fecha y hora prometida?"></asp:Label>
                    </td>
                ...
                <tr>
                    <td class="style5">
                        <asp:Label runat="server" ID="Label4" Text="4.- ¿El asesor  se comunico durante el servicio?"></asp:Label>
                    </td>
                ...
                <tr>
                    <td class="style5">
                        <asp:Label runat="server" ID="Label5" Text="5.- En general, ¿le resulto fácil comunicarse a su distribuidora mazda plasencia?"></asp:Label>
                    </td>
                ...
                <tr>
                    <td class="style5">
                        <asp:Label runat="server" ID="Label7" Text="6.- ¿Su vehiculo fue  reparado correctamente a la primera?"></asp:Label>
                    </td>
                    
                    <td class="style6" bgcolor="#CCCCCC">
                         <asp:RadioButtonList ID="OPT6" runat="server"  
                                        RepeatDirection="Horizontal" Width="192px">
                                        <asp:ListItem Value="SI"></asp:ListItem>
                                        <asp:ListItem Value="NO"></asp:ListItem>                                        
                                    </asp:RadioButtonList>
                ...
                <tr>
                    <td>
                       <asp:Label runat="server" ID="Label27" Text="¿Tiene alguna pieza pendiente con nosostros?"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox runat="server" ID="TXT9" Width="825px"  CssClass="txt"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                <td>
                       <asp:Label runat="server" ID="Label28" Text="  ¿Tendrá alguna duda, comentario o sugerencia que no quiera aportar?"></asp:Label>
                </td>
                </tr>
                <tr>
                <td>
                ...
                <table>
                            ...
                            <tr>
                    <td>
                        <asp:Label runat="server" ID="lblPregunta11" Text="Pregunta 1:"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox runat="server" ID="txtRespuesta1" Width="825px" Height="30px" CssClass="lstM" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label runat="server" ID="lblPregunta2" Text="Pregunta 2:"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox runat="server" ID="txtRespuesta2" Width="825px" Height="30px" CssClass="lstM" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label runat="server" ID="lblPregunta3" Text="Pregunta 3:"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox runat="server" ID="txtRespuesta3" Width="825px" Height="30px" CssClass="lstM" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label runat="server" ID="lblPregunta4" Text="Pregunta 4:"></asp:Label>
                        
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox runat="server" ID="txtRespuesta4" Width="825px" Height="30px" CssClass="lstM" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label runat="server" ID="lblPregunta5" Text="Pregunta 5:"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox runat="server" ID="txtRespuesta5" Width="825px" Height="30px" CssClass="lstM" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                </table>
                ...
                <tr>
                    <td>
                        <asp:Label runat="server" ID="lblAdicional" Text="6.- Adicional: Su auto quedo reparado bien a la primera vez:"></asp:Label>
                    </td>
                    
                    <td class="style6" bgcolor="#CCCCCC">
                     <asp:RadioButtonList ID="optAdic" runat="server"  
                                        RepeatDirection="Horizontal" Width="192px">
                                        <asp:ListItem Value="SI" ></asp:ListItem>
                                        <asp:ListItem Value="NO" ></asp:ListItem>
                                          </asp:RadioButtonList>       
                ...
                <tr>
                    <td>
                        <asp:Label runat="server" ID="lblNoPorque" Text="No ¿Porque?"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox runat="server" ID="txtNoPorque" Width="825px" Height="30px" CssClass="lstM" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr><td>   &nbsp;</td></tr>
                <tr>
