<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="zcrmSeguimiento.aspx.vb" Inherits="TablerosV2.zcrmSeguimiento" %>
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="dg1" runat="server" AutoGenerateColumns="False" ForeColor="#333333"
                       CssClass="grd"    AllowPaging="true" PageSize="15" Font-Size="Small" CellPadding="4"
                        GridLines="None">
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="Orden" HeaderText="Orden" SortExpression="Orden"
                             ...
                             <asp:BoundColumn DataField="Nom_Cliente" HeaderText="Cliente" ReadOnly="True" SortExpression="nom_cliente" />
                              ...
                              <asp:BoundColumn DataField="Fecha_Estatus" DataFormatString = "{0:d}" HeaderText="Fecha Estatus" SortExpression="Fecha_Estatus"></asp:BoundColumn>
                              
                            <asp:BoundColumn DataField="Fecha_Captura" DataFormatString = "{0:d}" HeaderText="Fecha_Captura" SortExpression="Fecha_Captura"
                                ReadOnly="True">
