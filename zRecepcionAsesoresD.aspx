<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="zRecepcionAsesoresD.aspx.vb" Inherits="TablerosV2.zRecepcionAsesoresD" %>
...
<asp:Label ID="lblIdAsesor" runat="server"></asp:Label>
 ...
 <asp:Button runat="server" ID="cmdMPGV2" Style="display: none;" />
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <asp:Label runat="server" ID="lbllblModComentarios" Style="display: none; color: MIDNIGHTBLUE; cursor: auto; font-size: 11px; font-weight: BOLD;" Text="Comentarios:"></asp:Label>
                        </td>
                        <td>
        ...
        <tr><td>  
            <table><tr><td>
<h3 >Fecha:</h3> <asp:TextBox ID="txtCalendar"    AutoPostBack="true" runat="server" Style="display: block;
  ...
  <h3 >Buscar Placa:</h3> <input name="buscador" id="buscador" type="text" /> 
                            </td></tr></table>
       ...
       <h3 >Con Cita</h3>
                    <div class="GrdOver">
                        <asp:DataGrid ID="dg1" runat="server" AutoGenerateColumns="False" ForeColor="#333333"
                            ...
                            <Columns>
                               <asp:BoundColumn DataField="idVehiculo"  HeaderText=""  ItemStyle-Font-Size="1px" ItemStyle-ForeColor="Transparent"   />  
                                    ...
                                    <ItemTemplate>
                                       ...
                                       <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:LinkButton ID="lnknoPlacas" runat="server"><%# If(Eval("noplacas").ToString.Trim.Length > 0, Eval("noplacas"), "ninguno")%></asp:LinkButton></td>
                                                        </tr>
                                                    </table>
