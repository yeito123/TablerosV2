<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="zcrmCuestionarioEntregaDetalle.aspx.vb" Inherits="TablerosV2.zcrmCuestionarioEntregaDetalle" %>
            ...
            <table bgcolor="Silver">
                <tr>
                    <td bgcolor="White" class="style12">
                        <asp:Label runat="server" ID="Lblpregunta1" Text="De una escala del 1 al 6 siendo 1 muy insatisfecho y 6 muy satisfecho como califica"
                ...
                <tr>
                    <td class="style5">
                        <asp:DataGrid ID="dgPreguntas" runat="server" AutoGenerateColumns="False" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="7" CellSpacing="3" 
                            CssClass="grd100" Font-Size="Small" GridLines="Horizontal" ShowHeader="False">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn>
                                    ...
                                    <ItemStyle BackColor="#F8F8FC" CssClass="grd70" Font-Bold="True" 
                                        Font-Italic="False" Font-Names="Arial" Font-Overline="False" Font-Size="12px" 
