<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="_nzrecepcionEntregas.aspx.vb" Inherits="TablerosV2._nzrecepcionEntregas" %>
            ...
            <div class="col-md-12">
                <asp:DataGrid ID="dg1" runat="server" GridLines="None"  AutoGenerateColumns="False" CssClass="table table-striped table-condensed" ShowHeaderWhenEmpty="true">
                    ...
                    <Columns>
                            ...
                            <ItemTemplate>
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding-right: 1em;width:3em;">
                                            <asp:Label ID="lblInfi" runat="server" Text='<%# Eval("id_hd") & "__" & If(Eval("horallegada") Is DBNull.Value, "00:00", Eval("horallegada")) & "__" & Eval("Cliente") & "__" & Eval("noplacas") & "__" & Eval("VIN") & "__" & Eval("vehiculo") &   "__" & Eval("noorden")%>' Visible="false"></asp:Label> 

                                            <asp:Label ID="lblIdVehiculo" runat="server" Text='<%# Eval("idVehiculo") %>'></asp:Label></td>
                                        <td>
                                            <asp:LinkButton ID="lnkPlacas" runat="server" OnClick="lnkPlacas_Click"  CssClass="btn  btn-info" style="width:7em;" ><%# Eval("NOPlacas") %></asp:LinkButton></td>
                                    </tr>
                                </table>
                        ...
                        <asp:BoundColumn DataField="Fecha" HeaderText="Fecha"  DataFormatString="{0:d}"    />
