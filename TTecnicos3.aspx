<%@ Page Language="vb" AutoEventWireup="false" enableViewState="true" CodeBehind="TTecnicos3.aspx.vb" Inherits="TablerosV2.TTecnicos3" %>
        ...
        <div   id="pnlComent" class="cpnlComent">
         ...
         <div   id="pnlFin" class="cpnlComent">
            ...
            <table>
              ...
              <tr><td><asp:TextBox runat="server" ID="txtComenFin" Font-Size="14px" TextMode="MultiLine"/></td></tr>
                <tr><td>      
                     <asp:Button runat="server" ID="btnFin3" Text="Finalizar y Enviar a Calidad" />
                     <asp:Button runat="server" ID="btnFin4" Text="Finalizar y Hacer Prueba De Ruta" />
