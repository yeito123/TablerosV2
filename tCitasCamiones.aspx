<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tCitasCamiones.aspx.vb" Inherits="TablerosV2.tCitasCamiones" %>
...
<body onload="mReloj()">
	<form id="form1" runat="server">
						...
						<ItemTemplate>
							<div runat="server" id="divzed">
								<table>
									<tr>
										<td>
											<cc22:ZedGraphWeb OnRenderGraph="ZedGraphWeb1_RenderGraph" ID="ZedGraphWeb1" runat="server"
										...
										<td>
											<asp:Label runat="server" ID="lblPercentage" CssClass="cllabel"> </asp:Label></td>
										<td>
											<asp:Label runat="server" ID="lblPercentage2" CssClass="cllabel2"> </asp:Label></td>
										<td>
		...
		<div id="ind2" runat="server" style="position: absolute; top: 0; left: 0; z-index: 999;">
			<div>
				<%--   <table style=" font-size:14px;">
                   <tr><td style="background-color:darkgreen;width:30px;" >&nbsp;</td><td>Con Cita</td></tr>
                    <tr><td style="background-color: darkblue; width:30px;">&nbsp;</td><td>Sin Cita</td></tr>     
			...
			<asp:DataGrid ID="dgIndicadoresDias" runat="server" AutoGenerateColumns="false"
				ShowHeader="false" ShowFooter="false" CellPadding="0" CellSpacing="0" CssClass="clIndicadores">
				<AlternatingItemStyle BackColor="White" Font-Names="Arial" Font-Size="1px" ForeColor="White" />
				<ItemStyle BackColor="White" Font-Names="Arial" Font-Size="1px" ForeColor="White" />
				<HeaderStyle BackColor="White" Font-Bold="True" Font-Size="1px" ForeColor="White"
						...
						<ItemTemplate>
							<div runat="server" id="divzed">
								<table>
									<tr>
										<td>
											<cc22:ZedGraphWeb ID="ZedGraphWeb2" runat="server"
												FontSpec-Size="2" Legend-FontSpec-Size="0" Margins-Bottom="0" Margins-Left="0" Margins-Right="0" Margins-Top="0"
												Height="25" ChartBorder-IsVisible="false" IsFontsScaled="false" Legend-IsVisible="false"
												XAxis-FontSpec-Size="1" XAxis-Scale-FontSpec-Size="10"
												IsShowTitle="false" XAxis-IsShowTitle="false" YAxis-IsShowTitle="false" YAxis-IsVisible="false"
		...
		<div id="topfix0" runat="server" style="background-image: url('img/pleca_azulC.png'); background-repeat: repeat-x; height: 100%; position: absolute; top: 0px; left: 0px; width: 100%;">
		</div>
		<div id="leftfix" runat="server" style="width: 92px; position: absolute; left: 0px; background-color: white; z-index: 3001;">
		</div>
		<div id="floatdiv" style="background-image: url('img/pleca_azulC.png'); background-repeat: repeat-x; position: absolute; height: 100%; left: 0px; top: 0px; z-index: 3002; width: 100%;"
			runat="server">
			...
			<div id="buscador" style="z-index: 4999; position: absolute; top: 7px; left: 700px; color: white;">
				<table>
					<tr>
						<td>Buscar
							<asp:TextBox ID="txtFind" runat="server" Font-Size="11px" Style="width: 100px;" Visible="true" />
			...
			<div style="display: none; position: absolute; top: 0; z-index: 9999;">
				<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;" class="cssHeader000">
					<tr>
						...
						<td align="left">
							...
							||
							<asp:HyperLink
								ID="lnkUp" runat="server" Visible="false">Up</asp:HyperLink>
			...
			<input type="text" value="" runat="server" id="mymenu" style="z-index: 1000; left: 450px; position: absolute; top: 5px; background-color: transparent; border: none; color: black;" />
			<input type="text" value="" runat="server" id="dhtml" style="z-index: 1000; left: 550px; position: absolute; top: 5px; background-color: transparent; border: none; font-size: 12px; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif; color: transparent; font-weight: bold;" />
			<input type="text" value="Fecha: " style="z-index: 1000; left: 15px; position: absolute; top: 20px; background-color: Transparent; border: none; font-size: 12px; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif; color: transparent; font-weight: bold;" />
			<asp:Label ID="lblCalendar" runat="server" Style="display: none; z-index: 1000; left: 75px; position: absolute; top: 20px; background-color: Transparent; border: none; font-size: 12px; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif; color: White; font-weight: bold;"
				Text=""></asp:Label>
			<input type="text" value="Usuario: " style="z-index: 1000; left: 15px; position: absolute; top: 35px; background-color: Transparent; border: none; font-size: 12px; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif; color: White; font-weight: bold;" />
			<asp:Label ID="lblUsr" runat="server" Style="z-index: 1000; left: 75px; position: absolute; top: 35px; background-color: Transparent; border: none; font-size: 12px; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif; color: White; font-weight: bold;"
				Text=""></asp:Label>
			<input type="text" value="" runat="server" id="dhtmlChp" style="z-index: 1000; left: 850px; position: absolute; top: 5px; background-color: Transparent; border: none; font-size: 12px; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif; color: transparent; font-weight: bold;" />

			<input type="text" value="" runat="server" id="dhMenu" style="z-index: 1000; left: 550px; position: absolute; top: 5px; background-color: transparent; border: none; font-size: 12px; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif; color: transparent; font-weight: bold;" />

		</div>
		<div id="dchp" style="background-position: left top; z-index: 4999; left: 0px; width: 214px; position: absolute; top: 0px; height: 90px; border-left-color: blue; border-bottom-color: blue; border-top-color: blue; border-right-color: blue; font-family: 'Calibri'; background-color: white; background-image: url(img/chipText.PNG);"
		...
		<div style="z-index: 3003; left: 0px; width: 1121px; position: absolute; height: 500px;" id="divInterfaz"
			...
			<div id="divCalendar">
				<asp:TextBox ID="txtCalendar" AutoPostBack="true" runat="server" Style="display: block; z-index: 1000; left: 10px; position: absolute; top: 10px;"
					Text="Fecha" Width="1px"
					Height="1px" Font-Size="Medium" Font-Bold="False" ForeColor="White" />
				<img alt="" id="imgclCalendar" src="img/calendar.png" style="cursor: hand; z-index: 5000; left: 10px; position: absolute; top: 10px; background-color: Silver; border-bottom: solid 1px navy; width: 22px;" />
												...
												<td>
													<table width="100%">
														<tr>
															...
															<td>
																<asp:TextBox ID="txtBuscar" runat="server" Font-Size="12px" Style="width: 50px;" Visible="true" />
																<asp:ImageButton ID="imgBuscar" runat="server" ImageUrl="img/Find_32x32.png"
																	Style="height: 20px;" Visible="true" /></td>
															<td>Citas
                                            ...
                                            <asp:CheckBox runat="server" AutoPostBack="true" ID="chkAllCitas" />
																		<asp:DataGrid ID="gvDMS" runat="server" AutoGenerateColumns="False" CssClass="clgvDMS"
																			...
																			<Columns>
																				...
																				<asp:BoundColumn DataField="color" HeaderText="" SortExpression="" Visible="false"></asp:BoundColumn>
																				<asp:BoundColumn DataField="ano" HeaderText="" SortExpression="" Visible="false"></asp:BoundColumn>
																				<asp:BoundColumn DataField="cilindros" HeaderText="" SortExpression="" Visible="false"></asp:BoundColumn>

																				<asp:BoundColumn DataField="idasesor" HeaderText="" SortExpression="" Visible="false"></asp:BoundColumn>
																				<asp:BoundColumn DataField="vin" HeaderText="" SortExpression="" Visible="false"></asp:BoundColumn>
																				<asp:BoundColumn DataField="telefono" HeaderText="TELEFONO" SortExpression="" Visible="true"></asp:BoundColumn>
																				<asp:BoundColumn DataField="correo" HeaderText="CORREO" SortExpression="" Visible="true"></asp:BoundColumn>
																					...
																					<ItemTemplate>
																						...
																						<asp:DataGrid ID="GvTareas" runat="server" AutoGenerateColumns="false">
																							<Columns>
																								...
																								<asp:BoundColumn DataField="idServicio" HeaderText="Servicio" SortExpression="idServicio" Visible="false"></asp:BoundColumn>
															...
															<tr>
																<td colspan="4">
																	<asp:Panel runat="server" ID="pnlNuevaCita" Visible="false">
																		<div id='divLoader' style='display: block; background-color: #ffffff; position: absolute; width: 100%; height: 100%; border: #555555 3px solid; z-index: 10003; filter: alpha(opacity=95); left: 0px; top: 0px;'>
																			<table>
																				<tr>
																					<td>
																					...
																					<td>&nbsp;<asp:DropDownList ID="cboAsesor" runat="server" onchange="javascript:fPeriodos();">
																					</asp:DropDownList>
																					</td>
																					<td>HORA:
																					</td>
																					<td>&nbsp;<asp:DropDownList ID="cboHora" runat="server">
																					</asp:DropDownList>
																				...
																				<tr>
																					...
																					<td colspan="1">
																						<asp:TextBox ID="txtPlacas" runat="server" MaxLength="10" Width="120px"></asp:TextBox>
																					...
																					<td colspan="1">
																						<asp:TextBox ID="txtVin" runat="server" MaxLength="50" Width="120px"></asp:TextBox>
																				...
																				<tr>
																					...
																					<td>&nbsp;<asp:DropDownList ID="cboVehiculo" runat="server">
																					</asp:DropDownList></td>
																					<td>
																						...
																						<asp:Label runat="server" ID="lblTipoUnidad" Text="TIPO UNIDAD: "></asp:Label>

																					</td>
																					<td>
																						<asp:TextBox ID="txtColor" Visible="false" runat="server" MaxLength="25"></asp:TextBox>
																						<asp:DropDownList runat="server"  ID="cboTipoUnidad">
																							<asp:ListItem>Tracto</asp:ListItem>
																							<asp:ListItem>Bus</asp:ListItem>
																							<asp:ListItem>Sprinter</asp:ListItem>
																						</asp:DropDownList>
																						&nbsp;
																					</td>
																					<td>
																						...
																						<asp:Label runat="server" ID="LBLnE" Text="NUMERO ECONOMICO: "></asp:Label>
																					</td>
																					<td>
																						<asp:TextBox ID="txtAño" runat="server" MaxLength="50" onkeypress="VNumeros()"></asp:TextBox>
																						&nbsp;
																					</td>
																					<td>
																					...
																					<td>&nbsp;<asp:TextBox ID="txtCilindros" runat="server" MaxLength="2" onkeypress="VNumeros()">4</asp:TextBox>
																					</td>
																				</tr>
																				<tr>
																					<td>
																					...
																					<td colspan="1"></td>
																					<td align="right" colspan="3">&nbsp;<input type="text" id='arr12' name='arr12' value='686845685' style='display: none;' />
																				...
																				<tr>
																					<td><%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "campana") > 0, "CAMPANA: ", "")%> </td>
																					<td>
																						<asp:RadioButtonList runat="server" ID="rdlCampa">
																							<asp:ListItem Selected="True" Text="NO" Value="0"></asp:ListItem>
																							<asp:ListItem Text="SI" Value="1"></asp:ListItem>
																						</asp:RadioButtonList></td>
																					<td><%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "movilidad") > 0, "MOVILIDAD: ", "")%> </td>
																					<td>
																						<asp:RadioButtonList runat="server" ID="rdlMovilidad">
																							<asp:ListItem Selected="True" Text="NO" Value="0"></asp:ListItem>
																							<asp:ListItem Text="SI" Value="1"></asp:ListItem>
																						</asp:RadioButtonList></td>

																					<td align="left" colspan="3">
																						<asp:TextBox ID="txtMovilidad" Width="200px" runat="server"></asp:TextBox></td>
																				</tr>
																				<tr>
																					<td><%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "servicei") > 0, "SERVICE INCLUSIVE: ", "")%> </td>
																					<td>
																						<asp:RadioButtonList runat="server" ID="rdlServiceInclusive">
																							<asp:ListItem Selected="True" Text="NO" Value="0"></asp:ListItem>
																							<asp:ListItem Text="SI" Value="1"></asp:ListItem>
																						</asp:RadioButtonList></td>
																					<td><%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "garantia") > 0, "GARANTIA: ", "")%> </td>
																					<td>
																						<asp:RadioButtonList runat="server" ID="rdlGarantia">
																							<asp:ListItem Selected="True" Text="NO" Value="0"></asp:ListItem>
																							<asp:ListItem Text="SI" Value="1"></asp:ListItem>
																						</asp:RadioButtonList></td>
																					<td align="left" colspan="3">
																						<asp:TextBox ID="txtGarantia" Width="200px" runat="server"></asp:TextBox></td>
																				</tr>
																				<tr>
																					<td><%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "medio") > 0, "MEDIO DE CONCRETACION DE CITA: ", "")%> </td>
																					<td>
																						<asp:DropDownList runat="server" ID="rdlMedio">
																							<asp:ListItem Selected="True" Text="WEB" Value="WEB"></asp:ListItem>
																							<asp:ListItem Text="Presencial" Value="Presencial"></asp:ListItem>
																							<asp:ListItem Text="Telefonica" Value="Telefonica"></asp:ListItem>
																							<asp:ListItem Text="Teleservices" Value="Teleservices"></asp:ListItem>
																							<asp:ListItem Text="Whastapp" Value="Whastapp"></asp:ListItem>
																						</asp:DropDownList></td>
																					<td><%=IIf(InStr(TablerosV2LibTypes.SCCParametros.ObtenParametros(Request.Url.Segments(Request.Url.Segments.Length - 1), "sCamposCaptura"), "contacto") > 0, "MEDIO PREFERIDO DE CONTACTO: ", "")%> </td>
																					<td>
																						<asp:DropDownList runat="server" ID="rdlContacto">
																							<asp:ListItem Selected="True" Text="Numero Celular" Value="Numero"></asp:ListItem>
																							<asp:ListItem Text="Whastapp" Value="Whastapp"></asp:ListItem>
    ...
    //-->
		...
		<div id="pnlComent" class="cpnlComent">
			...
			<table>
				...
				<tr>
					<td>
						<asp:TextBox runat="server" ID="txtComen" TextMode="MultiLine"></asp:TextBox></td>
				</tr>
				<tr>
					<td>
...
<script type="text/javascript"><!--
		...
		floatingMenu.move = function () {
			...
			my_cita.moveTo(floatingMenu.nextX, floatingMenu.nextY + document.documentElement.clientHeight - document.getElementById('divInterfaz').offsetHeight + 20);
