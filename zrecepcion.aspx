<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="zrecepcion.aspx.vb" Inherits="TablerosV2.zrecepcion" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div id="divNuevo">
                    ...
                    <div class="form-group">
                        <asp:label runat="server" Visible="false">Torre:</asp:label>
                        <asp:TextBox ID="txtTorre2" runat="server" Visible="false" CssClass="form-control input-sm"></asp:TextBox>
						<asp:label runat="server" Visible="false" >Tipo Unidad:</asp:label>
                        <asp:DropDownList ID="cmbTipoUnidad" runat="server" Visible="false" CssClass="form-control input-sm">
                    ...
                    <div class="form-group">
                        <asp:label runat="server">Asesor:</asp:label>
        ...
        <div class="row">
            <div class="col-md-12">
                <asp:DataGrid ID="dg1" runat="server" GridLines="None" AutoGenerateColumns="False" CssClass="table table-striped table-condensed" ShowHeaderWhenEmpty="true">
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="cCita" Visible="true" HeaderText="" />
                         <asp:BoundColumn DataField="TipoCliente" Visible="true" HeaderText="Tipo" />
                        ...
                        <asp:BoundColumn DataField="idve" Visible="false" HeaderText="id_hd" />
                          <asp:TemplateColumn HeaderText="Kilometraje" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <table>
                                    <tr>

                                        <td>
                                            <asp:LinkButton ID="lnkKilometraje" runat="server" OnClick="lnkTorre2_Click"><%# If(Eval("Kilometraje").ToString.Trim.Length > 0, Eval("Kilometraje"), "ninguno")%></asp:LinkButton></td>
                                    </tr>
                                </table>
                ...
                <asp:DataGrid ID="dg2" runat="server" AutoGenerateColumns="False" GridLines="None" CssClass="table table-striped table-condensed" ShowHeaderWhenEmpty="true" >
                    <ItemStyle />
                    <Columns>
                        <asp:TemplateColumn HeaderText="Placas" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblNoPacas" runat="server" Text='<%# Eval("NOPlacas")%>'></asp:Label></td>
                        ...
                        <asp:BoundColumn DataField="FECHA" HeaderText="Igreso" />

                        <asp:BoundColumn DataField="Dias" HeaderText="Dias En Taller" Visible="true" />
                        <asp:BoundColumn DataField="id_hd" Visible="false" />
                        <asp:BoundColumn DataField="noorden" HeaderText="N. Orden" Visible="true" />
                        <asp:BoundColumn DataField="asesor" HeaderText="Asesor" Visible="true" />
                        <asp:BoundColumn DataField="estado" HeaderText="Estado" Visible="true" />
			<asp:BoundColumn DataField="idVehiculo" HeaderText="N°" Visible="true" />
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <asp:Label runat="server" ID="lblModCliente" Visible="false" Style="color: MIDNIGHTBLUE; cursor: hand; font-size: 11px; font-weight: BOLD;" Text="Cliente"></asp:Label>
                                    <asp:Label runat="server" ID="lblTorre" Visible="false" Style="color: MIDNIGHTBLUE; cursor: hand; font-size: 11px; font-weight: BOLD;" Text="Kilometraje:"></asp:Label>
                                    <asp:Label runat="server" ID="lblModfecha" Visible="false" Style="color: MIDNIGHTBLUE; cursor: hand; font-size: 11px; font-weight: BOLD;" Text="Fecha Entrega:"></asp:Label>
                                    <asp:Label runat="server" ID="lblModPlacas" Visible="false" Style="color: MIDNIGHTBLUE; cursor: hand; font-size: 11px; font-weight: BOLD;" Text="Placas:"></asp:Label>
                                    <asp:Label runat="server" ID="lblModVehiculo" Visible="false" Style="color: MIDNIGHTBLUE; cursor: hand; font-size: 11px; font-weight: BOLD;" Text="Placas:"></asp:Label>
                                    <asp:Label runat="server" ID="lblEliminar" Visible="false" Style="color: MIDNIGHTBLUE; cursor: hand; font-size: 11px; font-weight: BOLD;" Text="Confirma eliminar este registro"></asp:Label>
