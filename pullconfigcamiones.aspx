<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pullconfigcamiones.aspx.vb" Inherits="TablerosV2.pullconfigcamiones" %>
...
<body>
	...
	<form id="form1" runat="server">
		...
		<div id="floatdiv" runat="server" style="position: absolute; width: 1225px; height: 90px; left: 0px; top: 0px; z-index: 3002;">
			...
			<input type="text" value="" runat="server" id="dhtml" style="z-index: 1000; left: 550px; position: absolute; top: 5px; background-color: Transparent; border: none; font-size: 12px; font-family: Arial; color: Transparent; font-weight: bold;" />
			<input type="text" value="Fecha: " style="z-index: 1000; left: 600px; position: absolute; top: 10px; background-color: Transparent; border: none; font-size: 12px; font-family: Arial; color: Transparent; font-weight: bold;" />
			<asp:Label ID="lblCalendar" runat="server" Style="z-index: 1000; left: 675px; position: absolute; top: 10px; background-color: Transparent; border: none; font-size: 12px; font-family: Arial; color: Transparent; font-weight: bold;"
				Text=""></asp:Label>
			<input type="text" value="Usuario: " style="z-index: 1000; left: 600px; position: absolute; top: 25px; background-color: Transparent; border: none; font-size: 12px; font-family: Arial; color: Transparent; font-weight: bold;" />
			<asp:Label ID="lblUsr" runat="server" Style="z-index: 1000; left: 675px; position: absolute; top: 25px; background-color: Transparent; border: none; font-size: 12px; font-family: Arial; color: Transparent; font-weight: bold;"
				Text=""></asp:Label>
		...
		<div id="HorizontalChip" style="z-index: 3006; position: absolute; top: 500px; left: 200px; height: 28px; width: 46px;">
			<img id="HorizontalChip1" alt="Horizontal" src="img/v_blue_h_l.gif" /></div>
		<div id="VerticalChip" style="z-index: 3006; position: absolute; top: 500px; left: 270px; height: 46px; width: 28px;">
			<img id="VerticalChip1" alt="Vertical" src="img/v_blue_v_l.gif" /></div>


		<div style="z-index: 3003; left: 0px; width: 1228px; position: absolute; top: 392px; height: 200px; background-image: url(img/controlCitas_Silver.png);"
			id="divInterfaz"
			runat="server" visible="true">
			<table cellspacing="0" cellpadding="0" style="border-width: 2px; border-color: #001340; width: 100%; background-color: #E5E5E5; font-size: 13px; font-weight: bold; border-top-style: solid; border-bottom-style: solid;">
